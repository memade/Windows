...
set PATH_INSTALL=%PATH_SRC%install\Win32\
set PATH_INSTALL_LIB=%PATH_INSTALL_TEMP%lib\
set PATH_INSTALL_DLL=%PATH_INSTALL_TEMP%dll\
set PATH_BIN=C:\openssl\Win32
cd %PATH_SRC%
rem pause
rem no-shared=>"/MT"
perl Configure VC-WIN32 no-shared no-asm enable-md2 enable-rc5 enable-fips --prefix=%PATH_INSTALL_TEMP%
rem pause
nmake
