...
rmdir /S/Q tmp32dll
perl Configure VC-WIN64A fips --openssldir=E:\www.skstu.com\Project.Gpl\openssl\openssl-1.0.2u threads no-ssl2 no-ssl3 no-idea no-mdc2 no-rc5 no-ec2m no-shared --with-fipsdir=E:\www.skstu.com\Project.Gpl\openssl\openssl-fips-2.0.16
