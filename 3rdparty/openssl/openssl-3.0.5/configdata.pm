...
our %config = (
    ...
    "perlargv" => [
        ...
        "enable-md2",
        "enable-rc5",
        "--prefix=D:\\__Github__\\Windows\\compile\\scripts\\openssl\\..\\..\\..\\3rdparty\\openssl\\openssl-3.0.5\\\\install\\"
    ],
    "perlenv" => {
        "AR" => undef,
        "ARFLAGS" => undef,
...
our %unified_info = (
    ...
    "dirinfo" => {
        ...
        "crypto\\evp" => {
            "deps" => [
                ...
                "crypto\\evp\\libcrypto-lib-legacy_md2.o",
        ...
        "crypto\\md2" => {
            "deps" => [
                "crypto\\md2\\libcrypto-lib-md2_dgst.o",
                "crypto\\md2\\libcrypto-lib-md2_one.o"
            ],
            "products" => {
                "lib" => [
                    "libcrypto"
        ...
        "crypto\\rc5" => {
            "deps" => [
                "crypto\\rc5\\libcrypto-lib-rc5_ecb.o",
                "crypto\\rc5\\libcrypto-lib-rc5_enc.o",
                "crypto\\rc5\\libcrypto-lib-rc5_skey.o",
                "crypto\\rc5\\libcrypto-lib-rc5cfb64.o",
                "crypto\\rc5\\libcrypto-lib-rc5ofb64.o"
            ],
            "products" => {
                "lib" => [
                    "libcrypto"
        ...
        "providers\\implementations\\digests" => {
            "deps" => [
                ...
                "providers\\implementations\\digests\\liblegacy-lib-md2_prov.o",
    ...
    "sources" => {
        ...
        "test\\buildtest_c_md2" => [
            "test\\buildtest_c_md2-bin-buildtest_md2.o"
        ],
        "test\\buildtest_c_md2-bin-buildtest_md2.o" => [
            "test\\buildtest_md2.c"
        ],
        ...
        "test\\buildtest_c_rc5" => [
            "test\\buildtest_c_rc5-bin-buildtest_rc5.o"
        ],
        "test\\buildtest_c_rc5-bin-buildtest_rc5.o" => [
            "test\\buildtest_rc5.c"
        ],
...
unless (caller) {
    ...
    use lib 'D:/__Github__/Windows/3rdparty/openssl/openssl-3.0.5/util/perl';
    use OpenSSL::fallback 'D:/__Github__/Windows/3rdparty/openssl/openssl-3.0.5/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'D:/__Github__/Windows/3rdparty/openssl/openssl-3.0.5/Configurations';
        use gentemplate;
