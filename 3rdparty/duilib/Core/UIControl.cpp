...
namespace DuiLib {
	...
	CControlUI* CControlUI::ApplyAttributeList(LPCTSTR pstrValue)
	{
#if 0
			/*
			button1normalimage="file='scrollbar.bmp' source='0,90,16,106' mask='#FFFF00FF'" 
			button1hotimage="file='scrollbar.bmp' source='18,90,34,106' mask='#FFFF00FF'" 
			button1pushedimage="file='scrollbar.bmp' source='36,90,52,106' mask='#FFFF00FF'" 
			button1disabledimage="file='scrollbar.bmp' source='54,90,70,106' mask='#FFFF00FF'" 
			button2normalimage="file='scrollbar.bmp' source='0,108,16,124' mask='#FFFF00FF'" 
			button2hotimage="file='scrollbar.bmp' source='18,108,34,124' mask='#FFFF00FF'" 
			button2pushedimage="file='scrollbar.bmp' source='36,108,52,124' mask='#FFFF00FF'" 
			button2disabledimage="file='scrollbar.bmp' source='54,108,70,124' mask='#FFFF00FF'" 
			thumbnormalimage="file='scrollbar.bmp' source='0,126,16,142' corner='2,2,2,2' mask='#FFFF00FF'"
			thumbhotimage="file='scrollbar.bmp' source='18,126,34,142' corner='2,2,2,2' mask='#FFFF00FF'" 
			thumbpushedimage="file='scrollbar.bmp' source='36,126,52,142' corner='2,2,2,2' mask='#FFFF00FF'" 
			thumbdisabledimage="file='scrollbar.bmp' source='54,126,70,142' corner='2,2,2,2' mask='#FFFF00FF'" 
			railnormalimage="file='scrollbar.bmp' source='0,144,16,160' corner='2,2,2,2' mask='#FFFF00FF'" 
			railhotimage="file='scrollbar.bmp' source='18,144,34,160' corner='2,2,2,2' mask='#FFFF00FF'"
			railpushedimage="file='scrollbar.bmp' source='36,144,52,160' corner='2,2,2,2' mask='#FFFF00FF'" 
			raildisabledimage="file='scrollbar.bmp' source='54,144,70,160' corner='2,2,2,2' mask='#FFFF00FF'" 
			bknormalimage="file='scrollbar.bmp' source='0,162,16,178' corner='2,2,2,2' mask='#FFFF00FF'" 
			bkhotimage="file='scrollbar.bmp' source='18,162,34,178' corner='2,2,2,2' mask='#FFFF00FF'" 
			bkpushedimage="file='scrollbar.bmp' source='36,162,52,178' corner='2,2,2,2' mask='#FFFF00FF'" 
			bkdisabledimage="file='scrollbar.bmp' source='54,162,70,178' corner='2,2,2,2' mask='#FFFF00FF'"


		button1normalimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button1hotimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button1pushedimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button1disabledimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button2normalimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button2hotimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button2pushedimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button2disabledimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		thumbnormalimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		thumbhotimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		thumbpushedimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		thumbdisabledimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		railnormalimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		railhotimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		railpushedimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		raildisabledimage="file='scrollbar1.bmp' source='0,0,16,16' corner='2,2,2,2' mask='#FFFF00FF'"
		bknormalimage="file='scrollbar1.bmp' source='16,0,32,16' corner='2,2,2,2' mask='#FFFF00FF'"
		bkhotimage="file='scrollbar1.bmp' source='16,0,32,16' corner='2,2,2,2' mask='#FFFF00FF'"
		bkpushedimage="file='scrollbar1.bmp' source='16,0,32,16' corner='2,2,2,2' mask='#FFFF00FF'"
		bkdisabledimage="file='scrollbar1.bmp' source='16,0,32,16' corner='2,2,2,2' mask='#FFFF00FF'"
			*/
#endif

		std::wstring default_config = LR"(
		button1normalimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button1hotimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button1pushedimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		button1disabledimage="file='scrollbar1.bmp' source='0,0,16,16' mask='#FFFF00FF'"
		...
		bool EnableDefaultStyle = false;

		if (EnableDefaultStyle) {

			// 解析样式表
			if (m_pManager != NULL) {
				LPCTSTR pStyle = m_pManager->GetStyle(default_config.c_str());
				if (pStyle != NULL) {
					return ApplyAttributeList(pStyle);
				}
			}
			CDuiString sXmlData = default_config.c_str();
			sXmlData.Replace(_T("&quot;"), _T("\""));
			LPCTSTR pstrList = sXmlData.GetData();
			// 解析样式属性
			CDuiString sItem;
