...
const char EXCHANGE_ACCOUNT[] = "Account";
const char ENABLE_PROTOCOL_FILE_LOG[] = "EnableProtocolFileLog";
/*
...
public:
  ...
  SessionSettings( const std::string& data,const std::string& path, bool resolveEnvVars = false) throw(ConfigError);
