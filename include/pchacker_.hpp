...
namespace pchacker {
 ...
 namespace libcurlpp {
  ...
  enum class EnPerformType : unsigned long long {
   SingleSync = 0x0000,
   SingeAsync = 0x0100,
   MultiSync = 0x1000,
   MultiAsync = 0x1100,
  ...
  class ILibcurlConfigure {
  public:
   virtual const std::time_t& PerformSequentialIntervalMS() const = 0;
   virtual const std::time_t& PerformMultiSyncIntervalMS() const = 0;
   virtual const std::time_t& PerformMultiAsyncIntervalMS() const = 0;
   virtual const std::time_t& PerformSingleSyncIntervalMS() const = 0;
   virtual const std::time_t& PerformSingleSingeAsyncIntervalMS() const = 0;
   virtual void PerformSequentialIntervalMS(const std::time_t&) = 0;
   virtual void PerformMultiSyncIntervalMS(const std::time_t&) = 0;
   virtual void PerformMultiAsyncIntervalMS(const std::time_t&) = 0;
   virtual void PerformSingleSyncIntervalMS(const std::time_t&) = 0;
   virtual void PerformSingleSingeAsyncIntervalMS(const std::time_t&) = 0;
   virtual const std::time_t& PerformNotifyIntervalMS() const = 0;
   virtual void PerformNotifyIntervalMS(const std::time_t&) = 0;
  protected:
   ILibcurlConfigure() {}
   ~ILibcurlConfigure() {}
  };
  ...
  public:
   ...
   virtual EnPerformType PerformType() const = 0;
   virtual const IProgressInfo* DownProgress() const = 0;
   virtual const IProgressInfo* UploadProgress() const = 0;
  protected:
   IResponse() {}
   ~IResponse() {}
  };

  using tfPerformNotifyCallback = std::function<void(IResponse*)>;
  ...
  public:
   ...
   virtual void Progress(const bool&) = 0;
   ...
   virtual void PerformType(const EnPerformType&) = 0;
  protected:
   IRequest() {}
   ~IRequest() {}
  };
  ...
  class IHttpApi {
  public:
   virtual IRequest* CreateRequest(const TypeIdentify&, const EnPerformType&) = 0;
   virtual IRequest* GetRequest(const TypeIdentify&) const = 0;
   virtual void Requests(const std::function<void(IRequest*)>&) = 0;
   ...
   virtual void RegisterPerformNotifyCallback(const tfPerformNotifyCallback&) = 0;
   virtual void Release() const = 0;
   virtual bool Start(ILibcurlConfigure*) = 0;
   virtual void Stop() = 0;
  };
