...
set COMPILE_CALL=%OPENSSL_SRC%ms\do_ms.bat
...
perl Configure VC-WIN32 --openssldir=%OPENSSL_SRC% threads no-asm no-ssl2 no-ssl3 no-idea no-mdc2 no-ec2m no-shared enable-md2 enable-rc5
