...
set COMPILE_OPENSSL_CALL=%OPENSSL_SRC%\ms\do_nasm.bat
...
perl Configure VC-WIN32 fips --openssldir=%OPENSSL_SRC% threads no-asm no-ssl2 no-ssl3 no-idea no-mdc2 no-ec2m no-shared enable-md2 enable-rc5 --with-fipsdir=%FIPS_SRC%
