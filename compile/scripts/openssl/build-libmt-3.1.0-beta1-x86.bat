...
set CURRENT=%cd%\
set ROOT=%CURRENT%..\..\..\
set OPENSSL_SRC=%CURRENT%..\..\..\3rdparty\openssl\openssl-3.1.0-beta1\
...
set INSTALL_INCLUDE=%ROOT%include\openssl\3.1.0-beta1\openssl\
set INSTALL_LIB=%ROOT%librarys\openssl\3.1.0-beta1\%PLATFORM%\
